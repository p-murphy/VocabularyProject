...
namespace November16th
{
    ...
    /// </summary>
    public sealed partial class MainPage : November16th.Common.LayoutAwarePage
    {
        public MainPage()
        {
        ...
        private void ToDictionary(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(DictionaryPage));
            }
        }
