...
namespace November16th
{
    ...
    /// </summary>
    public sealed partial class _8IntroResultsPage : November16th.Common.LayoutAwarePage
    {
        Collection c;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Appointment a = new Appointment(c, DateTime.Now.AddSeconds(10), ReviewStatus.SuggestedReview);
            Scheduler.instance.ScheduleQueue.Add(a);
        }
