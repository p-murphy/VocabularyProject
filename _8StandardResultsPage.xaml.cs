...
namespace November16th
{
    ...
    /// </summary>
    public sealed partial class _8StandardResultsPage : November16th.Common.LayoutAwarePage
    {
        Collection c;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            TextBlock1.Text = c.CollectionList[0].L2;
            TextBlock2.Text = c.CollectionList[1].L2;
            TextBlock3.Text = c.CollectionList[2].L2;
            TextBlock4.Text = c.CollectionList[3].L2;
            TextBlock5.Text = c.CollectionList[4].L2;
            TextBlock6.Text = c.CollectionList[5].L2;
            TextBlock7.Text = c.CollectionList[6].L2;
            TextBlock8.Text = c.CollectionList[7].L2;
