...
namespace November16th
{
    ...
    /// </summary>
    public sealed partial class _9StandardLearnerPage : November16th.Common.LayoutAwarePage
    {
        Collection c;
        ...
        private void ToStandardResults(object sender, RoutedEventArgs e)
        {
                if (this.Frame != null)
                {
                    this.Frame.Navigate(typeof(_9StandardResultsPage2), c.CollectionID);
                }
        }
