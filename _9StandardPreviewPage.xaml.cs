...
namespace November16th
{
    ...
    /// </summary>
    public sealed partial class _9StandardPreviewPage : November16th.Common.LayoutAwarePage
    {
        ...
        private void ToStandardLearner(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(_9StandardLearnerPage), c.CollectionID);
            }
        }
    }
}
