...
{
    public sealed partial class _9IntroPreviewPage : November16th.Common.LayoutAwarePage
    {
        Collection c;
        ...
        private void ToIntroLearner(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(_9IntroLearnerPagePart1), c.CollectionID);
            }
        }
    }
}
