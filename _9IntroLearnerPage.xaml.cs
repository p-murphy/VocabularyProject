...
namespace November16th
{
    ...
    /// </summary>
    public sealed partial class _9IntroLearnerPage : November16th.Common.LayoutAwarePage
    {
        Collection c;
        ...
        private void ToIntroResults(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                ...
                data.Add(c);
                data.Add(s);
                this.Frame.Navigate(typeof(_9IntroResultsPage), data);
            }
        }
    }
}
